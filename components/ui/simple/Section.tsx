...
export const Section: React.FC<SectionProps> = (props) => {
  ...
  var section = buildSimpleComponent(baseProps, sizeProps, remainingProps, "div", [
    ...
    stackProps.noPadding ? 'p-0' : ['pad-y-4', 'pad-y-5', 'pad-y-6', 'pad-y-7', 'pad-y-8'],
    stackProps.noPadding ? '' : ['pad-x-4', 'pad-x-5', 'pad-x-6', 'pad-x-7', 'pad-x-8'],
    stackProps.noPadding ? '' : ['lg-pad-x-3', 'lg-pad-x-4', 'lg-pad-x-5', 'lg-pad-x-6', 'lg-pad-x-7'],
    stackProps.noPadding ? '' : ['md-pad-x-2', 'md-pad-x-3', 'md-pad-x-4', 'md-pad-x-5', 'md-pad-x-6'],
